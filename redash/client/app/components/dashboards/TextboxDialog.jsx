...
function TextboxDialog({ dialog, isNew, ...props }) {
  ...
  return (
    <Modal
      {...dialog.props}
      title={isNew ? t("Add Textbox") : t("Edit Textbox")}
      onOk={saveWidget}
      onCancel={confirmDialogDismiss}
      cancelText={t("Cancel")}
      okText={isNew ? t("Add to Dashboard") : t("Save")}
      width={500}
      ...
      <div className="textbox-dialog">
        <Input.TextArea
          ...
          autoFocus
          placeholder={t("This is where you write some text")}
        />
        <small>
          {t("Supports basic")}{" "}
          <Link
        ...
        {text && (
          <React.Fragment>
            <Divider dashed />
            <strong className="preview-title">{t("Preview")}:</strong>
