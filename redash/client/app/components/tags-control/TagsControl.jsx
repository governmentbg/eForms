...
export const QueryTagsControl = modelTagsControl({
  archivedTooltip: t("This query is archived and can't be used in dashboards, or appear in search results."),
});

export const DashboardTagsControl = modelTagsControl({
  archivedTooltip: t("This dashboard is archived and won't be listed in dashboards nor search results."),
});
