...
function QuerySnippetDialog({ querySnippet, dialog, readOnly }) {
  ...
  const formFields = [
    { name: "trigger", title: t("Trigger"), type: "text", required: true, autoFocus: !isEditing },
    { name: "description", title: t("Description"), type: "text" },
    { name: "snippet", title: t("Snippet"), type: "ace", required: true },
  ...
  return (
    <Modal
      {...dialog.props}
      title={isEditing ? querySnippet.trigger : t("Create Query Snippet")}
      footer={[
