...
function NameInput({ name, type, onChange, existingNames, setValidation }) {
  ...
  return (
    <Form.Item required label={t("Keyword")} help={helpText} validateStatus={validateStatus} {...formItemProps}>
      ...
      <Form layout="horizontal" onFinish={onConfirm} id={paramFormId}>
        ...
        <Form.Item label={t("Type")} {...formItemProps}>
          <Select value={param.type} onChange={type => setParam({ ...param, type })} data-test="ParameterTypeSelect">
            ...
            <Option value="datetime-with-seconds">{t("Date and Time")} ({t("with seconds")})</Option>
            ...
            <Option value="datetime-range-with-seconds">{t("Date and Time Range")} ({t("with seconds")})</Option>
          </Select>
        </Form.Item>
        {param.type === "enum" && (
