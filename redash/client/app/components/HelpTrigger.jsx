...
export const TYPES = mapValues(
  {
    HOME: ["", t("Help")],
    VALUE_SOURCE_OPTIONS: ["/user-guide/querying/query-parameters#Value-Source-Options", t("Guide: Value Source Options")],
    SHARE_DASHBOARD: ["/user-guide/dashboards/sharing-dashboards", t("Guide: Sharing and Embedding Dashboards")],
    AUTHENTICATION_OPTIONS: ["/user-guide/users/authentication-options", t("Guide: Authentication Options")],
    USAGE_DATA_SHARING: ["/open-source/admin-guide/usage-data", t("Help: Anonymous Usage Data Sharing")],
    DS_ATHENA: ["/data-sources/amazon-athena-setup", t("Guide: Help Setting up Amazon Athena")],
    DS_BIGQUERY: ["/data-sources/bigquery-setup", t("Guide: Help Setting up BigQuery")],
    DS_URL: ["/data-sources/querying-urls", t("Guide: Help Setting up URL")],
    DS_MONGODB: ["/data-sources/mongodb-setup", t("Guide: Help Setting up MongoDB")],
    DS_GOOGLE_SPREADSHEETS: [
      "/data-sources/querying-a-google-spreadsheet",
      t("Guide: Help Setting up Google Spreadsheets"),
    ],
    DS_GOOGLE_ANALYTICS: ["/data-sources/google-analytics-setup", t("Guide: Help Setting up Google Analytics")],
    DS_AXIBASETSD: ["/data-sources/axibase-time-series-database", t("Guide: Help Setting up Axibase Time Series")],
    DS_RESULTS: ["/user-guide/querying/query-results-data-source", t("Guide: Help Setting up Query Results")],
    ALERT_SETUP: ["/user-guide/alerts/setting-up-an-alert", t("Guide: Setting Up a New Alert")],
    MAIL_CONFIG: ["/open-source/setup/#Mail-Configuration", t("Guide: Mail Configuration")],
    ALERT_NOTIF_TEMPLATE_GUIDE: ["/user-guide/alerts/custom-alert-notifications", t("Guide: Custom Alerts Notifications")],
    FAVORITES: ["/user-guide/querying/favorites-tagging/#Favorites", t("Guide: Favorites")],
    MANAGE_PERMISSIONS: [
      "/user-guide/querying/writing-queries#Managing-Query-Permissions",
      t("Guide: Managing Query Permissions"),
    ],
    NUMBER_FORMAT_SPECS: ["/user-guide/visualizations/formatting-numbers", t("Formatting Numbers")],
    PERCENT_FORMAT_SPECS: ["/user-guide/visualizations/formatting-numbers", t("Formatting Percentages")],
    GETTING_STARTED: ["/user-guide/getting-started", t("Guide: Getting Started")],
    DASHBOARDS: ["/user-guide/dashboards", t("Guide: Dashboards")],
    QUERIES: ["/user-guide/querying", t("Guide: Queries")],
    ALERTS: ["/user-guide/alerts", t("Guide: Alerts")],
  },
