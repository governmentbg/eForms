        ...
        <div className="bg-white tiled p-20">
          <Grid.Row type="flex" gutter={16}>
                ...
                {queryResult && options && (
                  <>
                    ...
                    <HorizontalFormItem label={t("Notifications")} className="form-item-line-height-normal">
                      <Rearm value={rearm || 0} />
                      <br />
                      {t("Set to")} {options.custom_subject || options.custom_body ? t("custom") : t("default")} {t("notification template.")}
                    </HorizontalFormItem>
                  </>
                )}
              </Form>
            ...
            <Grid.Col xs={24} md={8}>
              ...
              <h4>
                {t("Destinations")}{" "}
                <Tooltip title={t("Open Alert Destinations page in a new tab.")}>
