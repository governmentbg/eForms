    ...
    return (
      <React.Fragment>
        ...
        <div className="modal-header-desc">
          {t("Allow public access to this dashboard with a secret address.")} <HelpTrigger type="SHARE_DASHBOARD" />
        </div>
      </React.Fragment>
    );
  }
      ...
      <Modal {...dialog.props} title={this.constructor.headerContent} footer={null}>
        <Form layout="horizontal">
          {!this.props.hasOnlySafeQueries && (
            <Form.Item>
              <Alert
                message={t("For your security, sharing is currently not supported for dashboards containing queries with text parameters. Consider changing the text parameters in your query to a different type.")}
                type="error"
              />
            </Form.Item>
          )}
          <Form.Item label={t("Allow public access")} {...this.formItemProps}>
            <Switch
          ...
          {dashboard.public_url && (
            <Form.Item label={t("Secret address")} {...this.formItemProps}>
