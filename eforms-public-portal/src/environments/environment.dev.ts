export const environment = {
  ...
  production: false,
  apiUrl: 'http://10.191.35.200:8003/api',
  stsServer: 'http://10.191.35.200:9090',
  ...
  formIoUrl: 'http://10.191.35.200:3000',
  processEngineUrl: 'http://10.191.35.200:8001',
  autosaveEveryNMinutes: 5,
  ePaymentLoginUrl: 'https://pay-test.egov.bg/Account/EAuth',
  keycloak: 'http://10.191.35.200:9090',
  redashUrl: 'http://redash.daeudev.loc:8010'
};
