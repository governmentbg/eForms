...
@Component({
  selector: 'app-help-processing-eau',
  templateUrl: './help-processing-eau.component.html',
  styleUrls: ['./help-processing-eau.component.scss']
})
export class HelpProcessingEauComponent implements OnInit {
  ...
  ngOnInit(): void {
      this.formioService.getFormByAlias('system/help/information-processing-eau', environment.formioBaseProject).subscribe(result => {      
      this.formSrc = result;
