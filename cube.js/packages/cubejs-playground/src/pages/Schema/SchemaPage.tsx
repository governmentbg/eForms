...
export default class SchemaPage extends Component<SchemaPageProps, any> {
  ...
  async generateSchema() {
    ...
    if (res.status === 200) {
      ...
      Modal.success({
        title: t('Schema files successfully generated!'),
        content: t('You can start building the charts'),
        okText: t('Build'),
        cancelText: t('Close'),
        okCancel: true,
        onOk() {
  ...
  render() {
    ...
    return (
      <Layout style={{ height: '100%' }}>
        <Sider width={400} className="schema-sidebar">
          <Tabs
            activeKey={activeTab}
          ...
          >
            <TabPane tab={t("Tables")} key="schema">
        ...
        >
          ...
          {selectedFile ? (
            ...
            <Empty
              style={{ marginTop: 50 }}
              description={t("Select tables to generate Cube.js schema")}
            />
          )}
