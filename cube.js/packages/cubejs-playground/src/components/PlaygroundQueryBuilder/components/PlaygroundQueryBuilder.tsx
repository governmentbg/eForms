              ...
              <Col span={24}>
                <Card bordered={false} style={{ borderRadius: 0 }}>
                  <Row align="top" gutter={0} style={{ marginBottom: -12 }}>
                    <Section>
                      <SectionHeader>{t("Measures")}</SectionHeader>
                      <MemberGroup
                        disabled={isFetchingMeta}
                        members={measures}
                        availableMembers={availableMembers?.measures || []}
                        missingMembers={missingMembers}
                        addMemberName={t("Measure")}
                    ...
                    <Section>
                      <SectionHeader>{t("Segment")}</SectionHeader>
                      <MemberGroup
                        disabled={isFetchingMeta}
                        members={segments}
                        availableMembers={availableMembers?.segments || []}
                        missingMembers={missingMembers}
                        addMemberName={t("Segment")}
                        updateMethods={playgroundActionUpdateMethods(
                          updateSegments,
                          'Segment'
                        )}
                    ...
                    <Section>
                      <SectionHeader>{t("Time")}</SectionHeader>
                      <TimeGroup
                        disabled={isFetchingMeta}
              ...
              <Col span={24}>
                ...
                {!isQueryPresent && !metaError && (
                  <h2 style={{ textAlign: 'center' }}>
                    {t("Choose a measure or dimension to get started")}
                  </h2>
                )}
