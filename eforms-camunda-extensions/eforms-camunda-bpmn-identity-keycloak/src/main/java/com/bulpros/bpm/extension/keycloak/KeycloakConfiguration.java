...
public class KeycloakConfiguration {
	...
	protected boolean usePersonIdentifierAsCamundaUserId = false;
	/**
	...
	public boolean isUsePersonIdentifierAsCamundaUserId() {
		return usePersonIdentifierAsCamundaUserId;
	}

	public void setUsePersonIdentifierAsCamundaUserId(boolean usePersonIdentifierAsCamundaUserId) {
		this.usePersonIdentifierAsCamundaUserId = usePersonIdentifierAsCamundaUserId;
	}
