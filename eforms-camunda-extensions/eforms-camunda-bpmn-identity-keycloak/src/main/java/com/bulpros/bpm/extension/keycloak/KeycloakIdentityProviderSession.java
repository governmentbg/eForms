...
import com.bulpros.bpm.extension.keycloak.cache.QueryCache;
import com.bulpros.bpm.extension.keycloak.rest.KeycloakRestTemplate;
import com.bulpros.bpm.extension.keycloak.util.ContentType;
...
public class KeycloakIdentityProviderSession implements ReadOnlyIdentityProvider {
	 ...
	 * 
	 * @see KeycloakUserService#getKeycloakAdminUserId(java.lang.String)
	 */
	...
	protected String getKeycloakUsername(String userId) throws KeycloakUserNotFoundException, RestClientException {
		...
		if (keycloakConfiguration.isUsePersonIdentifierAsCamundaUserId()) {
			Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
			if (authentication.getPrincipal() instanceof OidcUser) {
				OidcUser user = (OidcUser) authentication.getPrincipal();
				userId = (String) user.getClaims().get("sub");
			}
			return userId;
		}
		try {
	 ...
	 * 
	 * @see KeycloakGroupService#getKeycloakAdminGroupId(java.lang.String)
	 */
