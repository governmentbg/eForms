...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public FilterRegistrationBean containerBasedAuthenticationFilter() {
        ...
        filterRegistration.setInitParameters(Collections.singletonMap("authentication-provider",
                "com.bulpros.eforms.processengine.keycloak.sso.KeycloakAuthenticationProvider"));
        filterRegistration.setOrder(101); // make sure the filter is registered after the Spring Security Filter Chain
        filterRegistration.addUrlPatterns("/app/*");
        return filterRegistration;
    }

    // The ForwardedHeaderFilter is required to correctly assemble the redirect URL
    // for OAUth2 login.
