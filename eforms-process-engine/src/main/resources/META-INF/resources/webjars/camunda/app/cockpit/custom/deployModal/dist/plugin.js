...
function useBootstrapPrefix(prefix, defaultPrefix) {
  var prefixes = react.exports.useContext(ThemeContext);
...
var Fade = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var className = _ref.className,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$m);

  var handleEnter = react.exports.useCallback(function (node) {
  ...
  return /*#__PURE__*/React.createElement(Transition, _extends$1({
    ...
    return /*#__PURE__*/React.cloneElement(children, _extends$1({}, innerProps, {
...
var _excluded$l = ["label", "onClick", "className"];
var propTypes$2 = {
...
var CloseButton = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var label = _ref.label,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$l);
...
function createWithBsPrefix(prefix, _temp) {
  ...
  var BsComponent = /*#__PURE__*/React.forwardRef(function (_ref2, ref) {
    var className = _ref2.className,
        ...
        props = _objectWithoutPropertiesLoose$2(_ref2, _excluded$k);
...
var _excluded$j = ["as", "disabled", "onKeyDown"];
...
var SafeAnchor = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var _ref$as = _ref.as,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$j);
...
var _excluded$i = ["bsPrefix", "variant", "size", "active", "className", "block", "type", "as"];
var defaultProps$5 = {
  variant: 'primary',
  active: false,
  disabled: false
...
function useTimeout() {
  ...
  var handleRef = react.exports.useRef();
...
var FormCheckLabel = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var bsPrefix = _ref.bsPrefix,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$e);
...
var FormCheck = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var id = _ref.id,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$d);
  ...
  var innerFormContext = react.exports.useMemo(function () {
    return {
...
var FormFile = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var id = _ref.id,
      ...
      props = _objectWithoutPropertiesLoose$2(_ref, _excluded$a);
...
var FormLabel = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  htmlFor = htmlFor || controlId;
  if (column) return /*#__PURE__*/React.createElement(Col, _extends$1({
    ref: ref,
    as: "label",
    className: classes,
    htmlFor: htmlFor
...
function useModalManager(provided) {
  ...
  return Object.assign(modal.current, {
    ...
    setDialogRef: react.exports.useCallback(function (ref) {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: react.exports.useCallback(function (ref) {
      modal.current.backdrop = ref;
    }, [])
  });
}

var Modal$1 = /*#__PURE__*/react.exports.forwardRef(function (_ref, ref) {
  ...
  var _useState = react.exports.useState(!show),
      exited = _useState[0],
      setExited = _useState[1];

  var lastFocusRef = react.exports.useRef(null);
  ...
  var removeFocusListenerRef = react.exports.useRef();
  var removeKeydownListenerRef = react.exports.useRef();
...
var _excluded$4 = ["bsPrefix", "className", "contentClassName", "centered", "size", "children", "scrollable"];
...
var _excluded$3 = ["bsPrefix", "closeLabel", "closeButton", "onHide", "className", "children"];
var defaultProps$2 = {
  closeLabel: 'Close',
  closeButton: false
};
var ModalHeader = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = react.exports.useContext(ModalContext);
...
var _excluded$2 = ["bsPrefix", "className", "style", "dialogClassName", "contentClassName", "children", "dialogAs", "aria-labelledby", "show", "animation", "backdrop", "keyboard", "onEscapeKeyDown", "onShow", "onHide", "container", "autoFocus", "enforceFocus", "restoreFocus", "restoreFocusOptions", "onEntered", "onExit", "onExiting", "onEnter", "onEntering", "onExited", "backdropClassName", "manager"];
var manager;
var defaultProps$1 = {
  show: false,
  backdrop: true,
...
var Modal = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var waitingForMouseUpRef = react.exports.useRef(false);
  var ignoreBackdropClickRef = react.exports.useRef(false);
  var removeStaticModalAnimationRef = react.exports.useRef(null); // TODO: what's this type
  ...
  var modalContext = react.exports.useMemo(function () {
    return {
      onHide: handleHide
    };
  }, [handleHide]);
  ...
  var renderBackdrop = react.exports.useCallback(function (backdropProps) {
...
var _excluded$1 = ["bsPrefix", "closeLabel", "closeButton", "className", "children"];
var defaultProps = {
  closeLabel: 'Close',
  closeButton: true
};
var ToastHeader = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = react.exports.useContext(ToastContext);
...
var Toast = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var delayRef = react.exports.useRef(delay);
  var onCloseRef = react.exports.useRef(onClose);
  react.exports.useEffect(function () {
  ...
  var autohideFunc = react.exports.useCallback(function () {
    if (autohideToast) {
  ...
  var toastContext = react.exports.useMemo(function () {
    return {
      onClose: onClose
    };
  }, [onClose]);
  var hasAnimation = !!(Transition && animation);
  var toast = /*#__PURE__*/React.createElement("div", _extends$1({}, props, {
    ref: ref,
...
function (_super) {
  ...
  function DeployModal(props) {
    ...
    _this.submit = function (event) {
      ...
      if (_this.fileRef.current.files.length < 1) {
        _this.fileRef.current.setAttribute("isInvalid", true);

        return;
      }

      if (!_this.fileRef.current.files[0].name.includes('.bpmn')) {
        _this.fileRef.current.setAttribute("isInvalid", true);
      ...
      formData.append('*', _this.fileRef.current.files[0]);
      fetch('/engine-rest/deployment/create', {
        method: "post",
        headers: {
          "Accept": "application/json",
          "X-XSRF-TOKEN": _this.props.camundaApi.CSRFToken
        },
        body: formData
      }).then(function (response) {
        if (response.status === 200) {
          _this.toastMessage = "Deployment successful!";
        } else {
          _this.toastMessage = "Error during deploy! " + response.statusText;
        }
    ...
    _this.fileRef = /*#__PURE__*/React.createRef();
    return _this;
  }

  DeployModal.prototype.render = function () {
    var _this = this;
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Modal, {
      ...
      onHide: this.onClose,
      animation: false
    }, /*#__PURE__*/React.createElement(Modal.Header, null, /*#__PURE__*/React.createElement(Modal.Title, null, "Deploy diagram")), /*#__PURE__*/React.createElement(Modal.Body, null, /*#__PURE__*/React.createElement(Toast$1, {
      animation: false,
      show: this.state.showToast
    }, /*#__PURE__*/React.createElement(Toast$1.Body, null, this.toastMessage)), /*#__PURE__*/React.createElement(FormImpl, {
      noValidate: true,
      onSubmit: function (e) {
        return _this.submit(e);
      }
    }, /*#__PURE__*/React.createElement(FormImpl.Group, {
      controlId: "form.file"
    }, /*#__PURE__*/React.createElement(FormFile, null, /*#__PURE__*/React.createElement(FormFile.Label, null, "Process Model"), /*#__PURE__*/React.createElement(FormFile.Input, {
      required: true,
      ref: this.fileRef
    }), /*#__PURE__*/React.createElement(Feedback, {
      type: "invalid"
    }, ".bpmn File upload is required."))), /*#__PURE__*/React.createElement(FormImpl.Row, {
...
function (_super) {
  ...
  DeployButton.prototype.render = function () {
    var _this = this;

    return /*#__PURE__*/react.exports.createElement(react.exports.Fragment, null, /*#__PURE__*/react.exports.createElement("a", {
      style: {
        cursor: "pointer"
      },
      onClick: function (e) {
    ...
    }, "Deploy"), /*#__PURE__*/react.exports.createElement(DeployModal, {
      onClose: this.toggleModal,
      showModal: this.state.showModal,
      camundaApi: this.props.camundaApi
    }));
  };
...
var plugin = {
  ...
  render: (node, {
    ...
    container = node;
    ReactDOM.render( /*#__PURE__*/React.createElement(DeployButton, {
      camundaApi: api
    }), container);
  },
  unmount: () => {
