...
public class ProvideFeedbackController extends AbstractFeedbackUIOperationController implements Initializable {
	...
	private static final Logger LOGGER = LogManager.getLogger(ProvideFeedbackController.class);
	...
	protected void doInit(Object... params) {
		...
		Platform.runLater(() ->
			message.setText(MessageFormat.format(
				Utf8ResourceBundle.getUTF8Bundle("bundles/nexu").getString("feedback.message"),
				Utf8ResourceBundle.getUTF8Bundle("bundles/nexu").getString("button.report.incident"), getApplicationName())));
	}
