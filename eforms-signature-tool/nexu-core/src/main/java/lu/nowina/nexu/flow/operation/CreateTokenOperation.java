...
import lu.nowina.nexu.pkcs11.Pkcs11Libs;
...
public class CreateTokenOperation extends AbstractCompositeOperation<Map<TokenOperationResultKey, Object>> {
    ...
    private static final Logger LOG = LogManager.getLogger(CreateTokenOperation.class.getName());
    ...
    private OperationResult<Map<TokenOperationResultKey, Object>> createTokenAdvanced() {
        ...
        map.put(TokenOperationResultKey.SELECTED_API, scAPI); // result.getResult());
        ...
        switch (scAPI) { // result.getResult()) {
            ...
            case MSCAPI:
                ...
                break;
            case PKCS_11:
                LOG.debug("Selected Card Terminal Label: " + selectedCard.getTerminalLabel());
                LOG.debug("App Config: " + this.api.getAppConfig().getNexuHome());
                String absolutePath = Pkcs11Libs
                        .getProviderAbsolutePath(
                                this.api.getEnvironmentInfo().getOs().name(),
                                selectedCard.getTerminalLabel(),
                                this.api.getAppConfig().getNexuHome());
                if (StringUtils.isEmpty(absolutePath)) {
                    ...
                    absolutePath = pkcs11Params.getPkcs11Lib().getAbsolutePath();
                }
