...
public class HttpsPlugin implements NexuPlugin {
	...
	private static final Logger LOGGER = LogManager.getLogger(HttpsPlugin.class.getName());
	...
	public List<InitializationMessage> init(String pluginId, NexuAPI api) {
		final ResourceBundle resourceBundle = Utf8ResourceBundle.getUTF8Bundle("bundles/https");
		final ResourceBundle baseResourceBundle = Utf8ResourceBundle.getUTF8Bundle("bundles/nexu");
