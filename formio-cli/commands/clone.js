...
module.exports = function(program, next) {
  program
    ...
    .option('-t, --tags <tags,...>', 'Include only forms having tags separated with commas.')
    .option('-e, --exclude-submissions-tags <tags,...>', 'Exclude submissions for forms having tags separated with commas.')
